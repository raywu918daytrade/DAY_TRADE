...
本模組提供 K 線技術型態（如三角收斂、W底、M頭、頭肩頂、頭肩底、杯柄、ABCD、突破壓力回測等 9 種型態）的自動識別演算、跨時間週期資料載入、FastAPI 端點與記憶體快取機制。
